...
st.markdown('<h1 class="chat-font">🤖 Teja Sri Clone Chatbot</h1>', unsafe_allow_html=True)
st.markdown('<h3 class="chat-font">Ask me anything, and I\'ll respond as Tejasri!</h3>', unsafe_allow_html=True)
st.markdown("---")
